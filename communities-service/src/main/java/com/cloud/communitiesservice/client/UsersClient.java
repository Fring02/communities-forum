...
import com.cloud.communitiesservice.dto.member.MemberRolesResponseDto;
...
public interface UsersClient {
    ...
    ResponseEntity<MemberRolesResponseDto> getUserRoles(@PathVariable("username") String username);
}
